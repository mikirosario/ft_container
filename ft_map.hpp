...
/*   Updated: 2021/12/06 01:45:12 by mikiencolor      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	template<typename Key, typename Value, typename Compare = ft::less<Key const>, typename Alloc = std::allocator<typename ft::bintree_pair<Key, Value>::t_bstnode> >
	class map
	{
		private:
